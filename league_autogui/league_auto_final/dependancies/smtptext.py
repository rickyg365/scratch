...
"""
To Do:
- add a list of host so we can rotate through, instead of relying on a single email
- maybe make a telegram version, better for when we got internet because the notifications are more instant and we can 
maybe even send pics so we can text back things like: "reroll", "change rune", "change spell1", "chat"

example:
- reroll
- change rune adc_aram
- change spell1 flash
- chat glhf!
