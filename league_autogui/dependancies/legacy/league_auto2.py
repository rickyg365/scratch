...
def find_accept_click(image_file, repeat=False):
    base_name, ext = image_file.split(".")
    print(f"[{base_name.title()}]")
    # print(base_name, ext)
    counter = 1
...
def find_decline_click(image_file, repeat=False):
    base_name, ext = image_file.split(".")
    print(f"[{base_name.title()}]")
    # print(base_name, ext)
    counter = 1
...
def find_play_again_click(image_file, repeat=False):
    base_name, ext = image_file.split(".")
    print(f"[{base_name.title()}]")
    # print(base_name, ext)
    counter = 1
...
def find_match_click(image_file, repeat=False):
    base_name, ext = image_file.split(".")
    print(f"[{base_name.title()}]")
    # print(base_name, ext)
    counter = 1
